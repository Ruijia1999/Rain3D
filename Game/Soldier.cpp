...
void Rain::Soldier::Update(double i_timeSinceLastFrame) {
   
}
Rain::Soldier::Soldier() :Entity() {

}
Rain::Soldier::Soldier(int i_id, std::string i_tag, std::string i_name) : Entity(i_id, i_tag, i_name) {
