...
namespace Rain {
	namespace Collision
	{
		...
		void GetSize(const int vertexCount, const Render::StaticVertexFormat* vertexData, float& outX, float& outY, float& outZ);
		void GetSize(const int vertexCount, const Render::StaticVertexFormat* vertexData, float& outRadius);
	};
}
