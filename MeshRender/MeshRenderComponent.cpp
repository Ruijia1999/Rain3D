...
Rain::MeshRender::MeshRenderComponent::MeshRenderComponent(int i_id, const std::shared_ptr <Render::Mesh>& i_mesh, const std::shared_ptr < Render::Effect>& i_effect, std::shared_ptr<Render::Texture> i_texture, Math::Vector4 i_color) {
	id = i_id;
	mesh = i_mesh;
	effect = i_effect;
	color = i_color;
